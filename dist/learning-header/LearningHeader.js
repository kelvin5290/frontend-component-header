...
var _excluded = ["href", "src", "alt", "userDomain"];
...
var LinkedLogo = function LinkedLogo(_ref) {
  ...
  React.useEffect(function () {
    if (userDomain) {
      setImgSrc("https://d2ttnbhfjsw4ca.cloudfront.net/".concat(userDomain, ".png"));
    }
  }, [userDomain]);
...
var LearningHeader = function LearningHeader(_ref3) {
  ...
  var userDomain = "";
  if (authenticatedUser && authenticatedUser.email) userDomain = authenticatedUser.email.split("@")[1].replaceAll(".", "_");
